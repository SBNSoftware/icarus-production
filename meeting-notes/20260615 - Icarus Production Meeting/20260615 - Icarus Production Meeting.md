## giu 15, 2026 09:00 GMT-5 | ICARUS Production Meeting

### Attendees

Alessandro Maria Ricci, Dihan Senadheera, Fatima Abd Alrahman, Giuseppe Cerati, Vito Di Benedetto, Tracy Usher, Manuel Dall’Olio, Mattia Sotgia, Saurav Saha
...
| Dcache Persistent Usage per user Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 91.4 TiB (80.4%) |   |
| ![](images/image5.png) |  |
...
* Assigned:  
  ...
  * Requests \#77-78 \[Manuel\]: priority  
    1. 77: 30% complete  
    2. 78: tested

    

  * Request \#79 \[Fatima\]: priority  
    1. 1.7% complete
...
* \[Giuseppe\] SBND is using some space in SBNDataPool. Some SBND datasets can be deleted \-\> still 6 TiB can be recovered. Totally, we recovered **22 TiB**.
...
* Investigate:  
  ...
  * Investigate with Thomas if his datasets contain duplicates

### Infrastructure

* \[Fatima\]: **ICARUS data available on the SBN SAM instance.** The script does not return errors, but the database is not migrated. Fatima is investigating why.
