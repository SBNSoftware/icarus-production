## giu 8, 2026 09:00 GMT-5 | ICARUS Production Meeting

### Attendees

Alessandro Maria Ricci, Daniel Carber, Saurav Saha, Manuel Dallolio, Vito Di Benedetto, Tracy Usher, Fatima Abn Alrahman, Dihan Senadheera, Giuseppe Cerati, Mattia Sotgia
...
| Dcache Persistent Usage per user Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 111TiB (97.1%) |   |
| ![](images/image5.png) |  |
...
* Saurav Sahajoined to the Production Team
...
* Assigned:  
  * Request \#32-33 \[Mattia\]:  
    1. 32: running  
    2. 33: running


  * Request \#41 \[Alessandro\]:  
    1. Issues with the lifetime


  * Request \#51 \[Alessandro\]:  
    1. Stage1 of request 108 not saved on tape \=\> regeneration ongoing


  * Request \#65 \[Antonio\]:  
  * Requests \#69-70 \[Thomas\]: Aurora  
  * Requests \#77-78 \[Manuel\]:  
  * Request \#79 \[Fatima\]:
...
* \[Mattia/Giuseppe\] SBND is using some space in SBNDataPool. Some SBND datasets can be deleted \-\> still 6 TiB can be recovered. Totally, we recovered **22 TiB**.
...
### Keepup Manager \[Manuel\]

### Data Manager \[Saurav\]

* Update the available samples in SBN Production wiki.  
* Investigate:  
  * /data\_stage1 TO BE DELETED  
  * /icarus\_keepup, ask for calibration ntuples of run3-run5 because we have multiple copies  
  * /mc/2025A\_ICARUS\_NuGraph2  
  * BNB Overlay campaign: check if we can remove some versions  
  * run3 specific runs with PMT wave forms?

### Infrastructure

* \[Fatima\]: **ICARUS data available on the SBN SAM instance.** Test of the script.

### Software

* \[Matteo\]: *icaruscode* reproducibility: ongoing. Here [details](https://shortbaseline.slack.com/docs/T7P7C3UAK/F0A0K0PRR16). Matteo checks with Jacob Smith, the release manager. You discovered that the issue was related to the initialization of some variables. We are waiting for a new Production release. The fix is not present in icaruscode v10\_06\_00\_06p03.
...
* \[Vito\]:  
  ...
  * The files in Resilient are deleted automatically after 30 days if they are not used.  
  * Jobsublite version was released two weeks ago.  
  * NERSC: FIFE project finished the hours \-\> We can not use Perlmutter anymore.  
  * SDumont in Brazil (LNCC): setup ongoing, available from June.