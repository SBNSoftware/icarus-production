...
## ago 17, 2026 09:00 GMT-5

## Attendees

Alessandro Maria Ricci, Matthew Siden, Vito Di Benedetto, Giuseppe Cerati, Tracy Usher, Saurav Saha, Dihan Senadheera, Manuel Dallolio, Giovanni Chiello
...
| **ICARUS dCache Persistent Usage per User** Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 103 TiB (90.3%) |  **SBN dCache Persistent Usage per User** Total is 426 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 71 TiB (16.7%) |
...
* Change cfg for future campaigns:  
...
* Manuel Check duplicates one time per week.
