## giu 29, 2026 09:00 GMT-5 | ICARUS Production Meeting

### Attendees

Alessandro Maria Ricci,Vito Di Benedetto, Fatima Abd Alrahman, Daniel Carber, Tracy Usher, Giuseppe Cerati
...
* Transfer of run2 raw data and stage 1 is blocked due to problems with FTS:  
  * \[Saurav/Vito\]: write a script to fix files without metadata.  
...
* \[Fatima\]: **ICARUS data available on the SBN SAM instance.** The script does not return errors, but the database is not migrated. Fatima is investigating why.  
  * Investigate stage0 and stage1 of Run3 NUMI:  
     production\_data\_2026\_ICARUS\_Run3\_NuMI\_RHC\_Run3\_Data\_numimajority\_v09\_89\_01\_02p02\_stage0  
    production\_data\_2026\_ICARUS\_Run3\_NuMI\_RHC\_Run3\_Data\_numimajority\_v09\_89\_01\_02p02\_stage1  
  * Investigate Run2 calibtuples:  
    Icaruspro\_2025\_wcdnn\_production\_NuMI\_Run2\_MinBias\_v10\_06\_00\_06p03\_numiminbias\_calibtuples 
