...
## set 14, 2026 09:00 GMT-5

## Attendees

Alessandro Maria Ricci, Matthew Siden, Fatima Abd Alrahman, Giuseppe Cerati, Vito Di Benedetto, Manuel Dallolio, Steven Doran
...
| **ICARUS dCache Persistent Usage per User** Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 110 TiB (95.9%) |  **SBN dCache Persistent Usage per User** Total is 426 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=sbn), Used space: 188 TiB (44.2%) |
...
* Request 96: submitted to NERSC  
* Request 100: Test  
* Requests 101-102: Ar25 is ongoing  
* Requests 114-115:  
  * 114: stage0 complete, stage1, larcv, caf  
  * 115: gen is ongoing  
...
* GiovanniVito Remove the old keepup datasets from SBNDataPool and scratch (icaruspro is using 900 TB and icarus group is using 1.6 PB):  
  * Stage0 in Scratch → COMPLETED  
  * Stage0 duplicates in SBNDataPool  
  * Calib ntuples in SBNDataPool  
...
* Dihan Clean the dataset stage1 of Run3 NuMI offbeam on tape: production\_data\_2026\_ICARUS\_Run3\_NuMI\_RHC\_Run3\_Data\_Offbeamnumimajority\_v09\_89\_01\_02p02\_stage \-\> the dataset contains also the calibration runs that must be removed.
...
* Alessandro Clean icaruspro home folder (131 GB):  
  * All 2022 folders  
* ICARUS Persistent:  
  * Dihan Contact SPINE to remove some of 12.55 TiB on ICARUS Persistent \-\> SPINE deleted 3 TiB and moving 4.7 TiB in SBN Persistent  
