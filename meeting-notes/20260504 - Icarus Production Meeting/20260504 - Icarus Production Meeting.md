## mag 4, 2026 09:00 GMT-5 | ICARUS Production Meeting

### Attendees

Alessandro Maria Ricci, Daniel Carber, Fatima Abd Alrahman, Manuel Dallolio, Giuseppe Cerati, Vito Di Benedetto, Promita Roy, Tracy Usher
...
| Dcache Persistent Usage per user Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 96.6 TiB (84.7%) |   |
| ![](images/image5.png) |  |
...
* Assigned:  
  * Request \#86 \[Manuel\]:  
    ...
    4. Larcv saved in SBNDataPool: 12 TB, the rest in scratch \-\> Move to Polaris  
    5. Some larcv in scratch maybe are lost \-\> check how many  
          
  * Request \#123 \[Fatima\]:  
    1. 95% is complete (1900 jobs to be processed)

    

  * Request \#8 \[Alessandro\]: Perlmutter  
    1. Stage0: 60% complete  
    2. Larcv: 1.3% complete


  * Request \#17 \[Promita\]: 90% complete 


  * Request \#32-33 \[Fatima\]: running
