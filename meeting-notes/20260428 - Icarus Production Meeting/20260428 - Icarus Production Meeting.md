## apr 28, 2026 09:00 GMT-5 | ICARUS Production Meeting

### Attendees

Alessandro Maria Ricci, Vito Di Benedetto, Daniel Carber, Fatima Abd Alrahman, Giuseppe Cerati, Manuel Dallolio, Tracy Usher, Christian Farnese
...
|  | ![](images/image3.png) |
| Dcache Persistent Usage per user Total is 114 TiB: [link](https://fifemon.fnal.gov/monitor/d/000000175/dcache-persistent-usage-by-vo?orgId=1&var-VO=icarus), Used space: 95.7 TiB (83.9%) |   |
| ![](images/image4.png) |  |
...
* A power outage due to the partial collapse of a high-voltage tower near the Batavia Road is impacting FermiGrid, SAM nodes and monitoring resources: FermiGrid is down, SBN SAM node is down, and it is impossible to monitor SBNDataPool and SBNData2Pool. Impossible to see the statistics of ICARUS exit codes.

### Requests

* Assigned:  
  * Request \#86 \[Manuel/Fatima\]:  
    1. See \#75. stage0 \-\> 100% complete  
    2. Stage1\_caf stopped \-\> 85% complete, 6000 files to be recovered  
    3. Used g4 wrong FHiCL.  
    4. Larcv saved in SBNDataPool: 12 TB, the rest in scratch  
          
  * Request \#123 \[Fatima\]:  
    1. 95% is complete (2100 jobs to be processed)

    

  * Request \#8 \[Alessandro\]:  
    1. Started gen\_g4\_detsim\_stage0 (10k jobs complete) at NERSC
  ...
  * Request \#15 \[Thomas\]:  
    1. Insert uncalibrated reference in the sam definitions\!


  * Request \#17-19 2026, 108 2025 \[Promita\]:  
    1. 17- complete  
...
* **Storage:** 496 TiB free on SBNDataPool.
...
* \[Vito\]:  
  ...
  * **Issue with hold jobs that are automatic released, ticket opened and error reproduced and understood**
